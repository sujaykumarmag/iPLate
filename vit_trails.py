...
def main():
    ...
    transform = torchvision.transforms.Compose([
        torchvision.transforms.Resize((args.img_size, args.img_size)),    # Resize images to 64x64 pixels
        torchvision.transforms.ToTensor(),          # Convert images to PyTorch tensors
        #torchvision.transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))  # Normalize pixel values to range [-1, 1]
    ])
    

    full_dataset = torchvision.datasets.ImageFolder(root='extracted_data/images/', transform=transform)
